      ...
      <div className="container min-h-screen rounded-xl bg-gray-100 p-4">
        <div className="mt-4 ml-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* Live Events Ongoing */}
            <div className="bg-white shadow-md rounded-lg p-6">
              <h2 className="text-lg font-semibold text-gray-700">Live Events Ongoing</h2>
              <p className="text-3xl font-bold text-green-500 mt-4">3</p>
            </div>

            {/* Noticeboard */}
            <div className="bg-white shadow-md rounded-lg p-6">
              <h2 className="text-lg font-semibold text-gray-700">Noticeboard</h2>
            ...
            <div className="bg-white shadow-md rounded-lg p-6">
              ...
              <p className="text-gray-600 mt-4">12 events planned this month</p>
            </div>

            {/* Revenue Generated */}
            <div className="bg-white shadow-md rounded-lg p-6">
              <h2 className="text-lg font-semibold text-gray-700">Revenue Generated</h2>
              <p className="text-3xl font-bold text-purple-500 mt-4">$45,300</p>
            </div>
